...
public class LoginServlet extends ChatServlet {
	...
	response) throws ServletException, IOException {
		...
		pw.println("<form action='/lab_8/' method='post'>Enter your name:<input type='text' name='name' value=''><input type='submit' value='Enter the chat'>");
	...
	HttpServletResponse response) throws IOException {
		...
		sessionTimeout*1000)) {
			...
			return "Sorry, but <strong>" + name + "</strong> is not availiable. Please, choose another!";
		}
	}
}
